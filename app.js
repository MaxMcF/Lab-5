...
function sumAndMultiply(a,b,c){ //eslint-disable-line
  ...
  var prodResult = multiply(multiply(a,b)[0],c)[0];
  var sumOutput = a + ' and ' + b + ' and ' + c + ' sum to ' + sumResult + '.';
  var prodOutput = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + prodResult + '.';
  return[sumResult, prodResult, sumOutput, prodOutput];
}
...
function sumArray(testArray){ //eslint-disable-line
  var arrayTotal = sum(sum(testArray[0],testArray[1])[0],testArray[2])[0];
  var stringArray = testArray + ' was passed in as an array of numbers, and ' + arrayTotal + ' is their sum.';
  return[arrayTotal, stringArray];
}
...
function multiplyArray(testArray){ //eslint-disable-line
  ...
  var stringArray = 'The numbers ' + testArray + ' have a product of ' + arrayProduct + '.';
  return[arrayProduct, stringArray];
}
